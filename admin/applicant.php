                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											if(isset($_POST["hapus1"])){
													$id = $_POST['id'];
													$delcv = mysqli_query($conn,"select * from applicant where applicant_id='$id'");
													$thecv = mysqli_fetch_array($delcv)['applicant_cv'];
													$cvx = '../'.$thecv;
													unlink($cvx);
											...
											if(isset($_POST["schedule"])){
													...
													$intview = mysqli_query($conn,"insert into applicant_scheduling values('','$ids','$alamat','$tanggal','$pic','$telp');");
														if($intview){
																...
																$mail->Host = 'mail.richard.id';
																$mail->Port = 465;
																$mail->SMTPSecure = 'ssl';
																$mail->SMTPAuth = true;
																$mail->Username = 'noreply@richard.id';
																$mail->Password = 'wkwk123wkwk';
																//Recipients
